    ...
    // }
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)){
              ...
              try{
                ...
                $sql = "INSERT INTO auditeurs (nom,prenom,num_aej,num_tel,email,fonction,date_inscription) 
                          VALUES ('$nom','$prenom','$num_aej','$num_tel','$email','$fonction','$date_inscription')";
                  
                $dbco->exec($sql);
                echo 'Votre engéristrement a été effectué avec succès ! ';
